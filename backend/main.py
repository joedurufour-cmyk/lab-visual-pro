...
app = FastAPI(title="Visual Lab PRO API", version="2.0")
...
# ============================================================
# Kimi LLM Helper (SINGLE definition — fixed bug)
# ============================================================
async def kimi_chat(messages: list, temperature: float = 0.5, max_tokens: int = 2000) -> str:
    if not KIMI_API_KEY:
...
@app.get("/")
async def root():
    return {"status": "Visual Lab PRO API running", "version": "2.0", "cav": True}
